...
Pod::Spec.new do |s|
  s.name             = 'KiNetworking'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KiNetworking.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/Anh Phan Tran/KiNetworking.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'KiNetworking/Classes/**/*'
